...
function activate(context) {
    ...
    const serverModule = context.asAbsolutePath(path.join('..', 'blade', 'dist', 'lsp', 'server.js'));
    ...
    const clientOptions = {
        ...
        synchronize: {
            ...
            fileEvents: vscode_1.workspace.createFileSystemWatcher('**/*.blade'),
        },
    };
    // Create the language client
    client = new node_1.LanguageClient('bladeLanguageServer', 'Blade Language Server', serverOptions, clientOptions);
